        ...
        <>
            <div
                className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50
                             ${
                                 sticky
                                     ? " shadow-md bg-white dark:bg-slate-800 dark:text-white duration-300 transition-all ease-in-out "
                                     : "dark:bg-slate-900" //added this
                             }`}
            >
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div>
                            <Link
                                to={"/cart"}
                                className="relative bg-orange-500 text-white px-3 py-2 rounded-md border-none btn hover:bg-orange-700 duration-300 cursor-pointer"
                            >
                                Cart
