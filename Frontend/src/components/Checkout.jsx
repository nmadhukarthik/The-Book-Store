    ...
    return (
        <div>
            <StripeCheckout
                ...
                currency="SGD"
            >
                <button className="btn bg-orange-500 w-[230px] cursor-pointer px-2 text-black border-none rounded-full border-[2px] hover:bg-orange-400 hover:text-white duration-200  dark:text-white max-w-screen-2xl container mx-auto md:px-20 ">
                    Pay Now
                </button>
            </StripeCheckout>
        </div>
